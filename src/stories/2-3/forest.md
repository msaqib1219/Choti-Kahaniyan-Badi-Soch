# Title: The Thirsty Sparrow
# Title (Urdu): پیاسی چڑیا
Level: 2-3
Moral: Helping others feels good!
Moral (Urdu): دوسروں کی مدد کرنا اچھا لگتا ہے!

## Scene 1
Text: A little sparrow is near a big Banyan tree. She is very thirsty.
Text (Urdu): ایک چھوٹی چڑیا برگد کے درخت کے پاس ہے۔ وہ بہت پیاسی ہے۔
Action Instruction: Tap the sparrow to help her fly
Action Instruction (Urdu): چڑیا کو اڑانے میں مدد کرنے کے لیے ٹچ کریں
Action Type: tap
...
Text (Urdu): زویا ٹھنڈے پانی کا ایک چھوٹا مٹی کا پیالہ (کنڈی) لاتی ہے۔
Action Instruction: Tap the water to fill the bowl
Action Instruction (Urdu): پیالہ بھرنے کے لیے پانی پر ٹچ کریں
...
Text (Urdu): چڑیا پانی پیتی ہے۔ تیں تیں! 'شکریہ زویا!'
Action Instruction: Tap the sparrow to hear her sing
Action Instruction (Urdu): چڑیا کا گانا سننے کے لیے ٹچ کریں
Action Type: tap
