# Title: The Secret of the Margalla Hills
# Title (Urdu): مارگلہ ہلز کا راز
Level: 6-8
Moral: Nature is a gift we must protect together.
Moral (Urdu): فطرت ایک تحفہ ہے جس کی ہمیں مل کر حفاظت کرنی چاہیے!

## Scene 1
Text: Ahmed and Hina are hiking in the hills. They see some trash near the spring.
Text (Urdu): احمد اور حنا پہاڑیوں میں ہائیکنگ کر رہے ہیں۔ وہ چشمے کے پاس کچرا دیکھتے ہیں۔
Action Instruction: Tap the trash to pick it up
Action Instruction (Urdu): کچرا اٹھانے کے لیے ٹچ کریں
...
Text (Urdu): وہ سارا کچرا تھیلوں میں ڈال دیتے ہیں۔ اب جنگل دوبارہ خوبصورت نظر آرہا ہے۔
Action Instruction: Tap the trees to see them shine!
Action Instruction (Urdu): درختوں کو چمکتا ہوا دیکھنے کے لیے ٹچ کریں!
Action Type: tap
...
Text (Urdu): ایک ہرن صاف پانی پینے آتا ہے۔ انہوں نے جنگل کی حفاظت کی!
Action Instruction: Tap the deer to show it's safe
Action Instruction (Urdu): ہرن کو محفوظ دیکھنے کے لیے ٹچ کریں
Action Type: tap
