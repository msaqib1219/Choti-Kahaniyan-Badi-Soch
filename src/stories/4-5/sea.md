# Title: The Crab's New Home
# Title (Urdu): کیکڑے کا نیا گھر
Level: 4-5
Moral: Helping a neighbor makes a community strong.
Moral (Urdu): ہمسایوں کی مدد کرنا معاشرے کو مضبوط بناتا ہے۔

## Scene 1
Text: Caspian the Crab lost his shell house near the rocks.
Text (Urdu): کیسپین کیکڑے نے اپنا گھر چٹانوں کے پاس کھو دیا۔
Action Instruction: Help Caspian look under the rocks
Action Instruction (Urdu): چٹانوں کے نیچے دیکھنے میں کیسپین کی مدد کریں
...
Text (Urdu): ایک دوستانہ مچھلی ایک چمکدار سیپ کی طرف اشارہ کرتی ہے۔ 'وہاں دیکھو!'
Action Instruction: Tap the shiny shell to show the crab
Action Instruction (Urdu): کیکڑے کو دکھانے کے لیے چمکدار سیپ پر ٹچ کریں
Action Type: tap
...
Text (Urdu): اب کیسپین کے پاس ایک محفوظ نیا گھر ہے۔ شکریہ مچھلی!
Action Instruction: Tickle the crab into his new home
Action Instruction (Urdu): کیکڑے کو اس کے نئے گھر میں گدگدی کریں
Action Type: tap
